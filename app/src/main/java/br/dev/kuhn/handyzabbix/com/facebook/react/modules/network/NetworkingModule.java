            ...
            try {
                ...
                if (readableMap2 == null || str.toLowerCase().equals("get") || str.toLowerCase().equals("head")) {
                    ...
                    if (str6 == null) {
                        ...
                        requestBody = RequestBody.create(MediaType.parse(str6), ByteString.decodeBase64(readableMap2.getString(REQUEST_BODY_KEY_BASE64)));
                    }
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        if (!NetworkingModule.this.mShuttingDown) {
                            ...
                            try {
                                ...
                                } else if (str9.equals(NetworkingModule.REQUEST_BODY_KEY_BASE64)) {
