...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    private CatalystInstanceImpl(ReactQueueConfigurationSpec reactQueueConfigurationSpec, JavaScriptExecutor javaScriptExecutor, NativeModuleRegistry nativeModuleRegistry, JSBundleLoader jSBundleLoader, NativeModuleCallExceptionHandler nativeModuleCallExceptionHandler) {
        ...
        FLog.m36d(ReactConstants.TAG, "Initializing React Xplat Bridge.");
        ...
        FLog.m36d(ReactConstants.TAG, "Initializing React Xplat Bridge before initializeBridge");
        ...
        FLog.m36d(ReactConstants.TAG, "Initializing React Xplat Bridge after initializeBridge");
        Systrace.endSection(0);
    ...
    public void runJSBundle() {
        FLog.m36d(ReactConstants.TAG, "CatalystInstanceImpl.runJSBundle()");
    ...
    public void callFunction(PendingJSCall pendingJSCall) {
        if (this.mDestroyed) {
            ...
            FLog.m88w(ReactConstants.TAG, "Calling JS function after bridge has been destroyed: " + pendingJSCall2);
            return;
        }
    ...
    public void destroy() {
        FLog.m36d(ReactConstants.TAG, "CatalystInstanceImpl.destroy() start");
                                ...
                                public void run() {
                                    AsyncTask.execute(new Runnable() {
                                        public void run() {
                                            ...
                                            FLog.m36d(ReactConstants.TAG, "CatalystInstanceImpl.destroy() end");
    ...
    public void initialize() {
        FLog.m36d(ReactConstants.TAG, "CatalystInstanceImpl.initialize()");
