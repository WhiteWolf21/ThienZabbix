...
@Metadata(mo24972bv = {1, 0, 3}, mo24973d1 = {"\u0000\f\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001H\n¢\u0006\u0002\b\u0003"}, mo24974d2 = {"<anonymous>", "", "Lexpo/modules/core/interfaces/Package;", "invoke"}, mo24975k = 3, mo24976mv = {1, 4, 1})
...
final class ExpoModulesPackage$Companion$packageList$2 extends Lambda implements Function0<List<? extends Package>> {
    ...
    public final List<Package> invoke() {
        try {
            ...
            if (invoke != null) {
                return CollectionsKt.sortedWith((List) invoke, new C1682xcc460724());
            }
