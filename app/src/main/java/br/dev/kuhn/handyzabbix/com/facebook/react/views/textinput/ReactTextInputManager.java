...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
    ...
    public Map<String, Object> getExportedCustomBubblingEventTypeConstants() {
        return MapBuilder.builder().put("topSubmitEditing", MapBuilder.m123of("phasedRegistrationNames", MapBuilder.m124of("bubbled", "onSubmitEditing", "captured", "onSubmitEditingCapture"))).put("topEndEditing", MapBuilder.m123of("phasedRegistrationNames", MapBuilder.m124of("bubbled", "onEndEditing", "captured", "onEndEditingCapture"))).put(ReactTextInputEvent.EVENT_NAME, MapBuilder.m123of("phasedRegistrationNames", MapBuilder.m124of("bubbled", "onTextInput", "captured", "onTextInputCapture"))).put(PickerFocusEvent.EVENT_NAME, MapBuilder.m123of("phasedRegistrationNames", MapBuilder.m124of("bubbled", "onFocus", "captured", "onFocusCapture"))).put(PickerBlurEvent.EVENT_NAME, MapBuilder.m123of("phasedRegistrationNames", MapBuilder.m124of("bubbled", "onBlur", "captured", "onBlurCapture"))).put(ReactTextInputKeyPressEvent.EVENT_NAME, MapBuilder.m123of("phasedRegistrationNames", MapBuilder.m124of("bubbled", "onKeyPress", "captured", "onKeyPressCapture"))).build();
    }

    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.builder().put(ScrollEventType.getJSEventName(ScrollEventType.SCROLL), MapBuilder.m123of("registrationName", "onScroll")).build();
    }

    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m124of("focusTextInput", 1, "blurTextInput", 2);
    }
    ...
    public void setKeyboardType(ReactEditText reactEditText, String str) {
        ...
        if (KEYBOARD_TYPE_NUMERIC.equalsIgnoreCase(str)) {
            ...
            i = KEYBOARD_TYPE_PHONE_PAD.equalsIgnoreCase(str) ? 3 : KEYBOARD_TYPE_VISIBLE_PASSWORD.equalsIgnoreCase(str) ? 144 : 1;
        }
    ...
    public Map getExportedViewConstants() {
        return MapBuilder.m123of("AutoCapitalizationType", MapBuilder.m126of("none", 0, "characters", 4096, "words", 8192, "sentences", 16384));
    }
    ...
    public Object updateState(ReactEditText reactEditText, ReactStylesDiffMap reactStylesDiffMap, StateWrapper stateWrapper) {
        ...
        return ReactTextUpdate.buildReactTextUpdateFromState(TextLayoutManager.getOrCreateSpannableForText(reactEditText.getContext(), map, this.mReactTextViewManagerCallback), state.getInt("mostRecentEventCount"), TextAttributeProps.getTextAlignment(reactStylesDiffMap, TextLayoutManager.isRTL(map)), TextAttributeProps.getTextBreakStrategy(map2.getString(ViewProps.TEXT_BREAK_STRATEGY)), TextAttributeProps.getJustificationMode(reactStylesDiffMap), map.getArray("fragments").toArrayList().size() > 1);
    }
}
