    ...
    public void sendIntent(String str, ReadableArray readableArray, Promise promise) {
        ...
        if (readableArray != null) {
            for (int i = 0; i < readableArray.size(); i++) {
                ...
                int i2 = C10701.$SwitchMap$com$facebook$react$bridge$ReadableType[map.getType(nextKey).ordinal()];
                if (i2 == 1) {
    ...
    static /* synthetic */ class C10701 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.modules.intent.IntentModule.C10701.<clinit>():void");
        }
    }
}
