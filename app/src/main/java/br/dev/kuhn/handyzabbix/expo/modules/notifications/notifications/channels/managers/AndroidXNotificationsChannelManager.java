package br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.channels.managers;
...
import br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.SoundResolver;
import br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.channels.InvalidVibrationPatternException;
import br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.channels.serializers.NotificationsChannelSerializer;
...
public class AndroidXNotificationsChannelManager implements NotificationsChannelManager {
    ...
    public AudioAttributes createAttributesFromArguments(ReadableArguments readableArguments) {
        ...
        if (readableArguments.containsKey(NotificationsChannelSerializer.AUDIO_ATTRIBUTES_USAGE_KEY)) {
            builder.setUsage(AudioUsage.fromEnumValue(readableArguments.getInt(NotificationsChannelSerializer.AUDIO_ATTRIBUTES_USAGE_KEY)).getNativeValue());
        }
        ...
        if (readableArguments.containsKey(NotificationsChannelSerializer.AUDIO_ATTRIBUTES_FLAGS_KEY)) {
            ...
            if (arguments.getBoolean(NotificationsChannelSerializer.AUDIO_ATTRIBUTES_FLAGS_ENFORCE_AUDIBILITY_KEY)) {
                i = 1;
            }
