...
/* renamed from: expo.modules.filesystem.FileSystemModule$downloadResumableStartAsync$progressListener$1$moduleRegistry$$inlined$getFromModuleRegistry$1 */
/* compiled from: ModuleRegistryDelegate.kt */
public final class C1710x93d27e0b extends Lambda implements Function0<T> {
    final /* synthetic */ ModuleRegistryDelegate this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C1710x93d27e0b(ModuleRegistryDelegate moduleRegistryDelegate) {
        super(0);
