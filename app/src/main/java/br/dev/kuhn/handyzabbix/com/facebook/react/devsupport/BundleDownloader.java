    ...
    public static class BundleInfo {
        ...
        public static BundleInfo fromJSONString(String str) {
            ...
            try {
                ...
                FLog.m49e(BundleDownloader.TAG, "Invalid bundle info: ", (Throwable) e);
                return null;
            }
        }
        ...
        public String toJSONString() {
            ...
            try {
                ...
                FLog.m49e(BundleDownloader.TAG, "Can't serialize bundle info: ", (Throwable) e);
                return null;
            }
        }
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(okhttp3.Call r9, okhttp3.Response r10) throws java.io.IOException {
                ...
                L_0x0082:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.devsupport.BundleDownloader.C09621.onResponse(okhttp3.Call, okhttp3.Response):void");
            }
        });
    }
        ...
        if (!new MultipartStreamReader(response.body().source(), str2).readAllParts(new MultipartStreamReader.ChunkListener() {
            public void onChunkComplete(Map<String, String> map, Buffer buffer, boolean z) throws IOException {
                if (z) {
                    ...
                    BundleDownloader.this.processBundleResult(str3, code, Headers.m191of(map), buffer, file2, bundleInfo2, devBundleDownloadListener2);
                    ...
                    try {
                        ...
                        FLog.m48e(ReactConstants.TAG, "Error parsing progress JSON. " + e.toString());
                    }
                }
            }
