...
public class SetNode extends Node {
    ...
    public SetNode(int i, ReadableMap readableMap, NodesManager nodesManager) {
        ...
        this.mValueNodeID = MapUtils.getInt(readableMap, RNConstants.ARG_VALUE, "Reanimated: Second argument passed to set node is either of wrong type or is missing.");
    }
