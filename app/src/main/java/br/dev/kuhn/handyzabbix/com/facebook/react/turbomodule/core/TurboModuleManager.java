...
public class TurboModuleManager implements JSIModule, TurboModuleRegistry {
    ...
    private com.facebook.react.turbomodule.core.interfaces.TurboModule getModule(java.lang.String r3, com.facebook.react.turbomodule.core.TurboModuleManager.TurboModuleHolder r4, boolean r5) {
        /*
            r2 = this;
            monitor-enter(r4)
            boolean r0 = r4.isDoneCreatingModule()     // Catch:{ all -> 0x008d }
            if (r0 == 0) goto L_0x0016
            if (r5 == 0) goto L_0x0010
            int r5 = r4.getModuleId()     // Catch:{ all -> 0x008d }
            com.facebook.react.turbomodule.core.TurboModulePerfLogger.moduleCreateCacheHit(r3, r5)     // Catch:{ all -> 0x008d }
        L_0x0010:
            com.facebook.react.turbomodule.core.interfaces.TurboModule r3 = r4.getModule()     // Catch:{ all -> 0x008d }
            monitor-exit(r4)     // Catch:{ all -> 0x008d }
            return r3
        L_0x0016:
            boolean r5 = r4.isCreatingModule()     // Catch:{ all -> 0x008d }
            r0 = 1
            r1 = 0
            if (r5 != 0) goto L_0x0023
            r4.startCreatingModule()     // Catch:{ all -> 0x008d }
            r5 = 1
            goto L_0x0024
        L_0x0023:
            r5 = 0
        ...
        L_0x003c:
            ...
            monitor-enter(r4)
            r4.setModule(r5)     // Catch:{ all -> 0x0058 }
        ...
        L_0x005b:
            ...
            monitor-enter(r4)
            r4.endCreatingModule()     // Catch:{ all -> 0x006b }
            r4.notifyAll()     // Catch:{ all -> 0x006b }
        ...
        L_0x006e:
            monitor-enter(r4)
        L_0x006f:
            boolean r3 = r4.isCreatingModule()     // Catch:{ all -> 0x008a }
            if (r3 == 0) goto L_0x007b
            r4.wait()     // Catch:{ InterruptedException -> 0x0079 }
            goto L_0x006f
        L_0x0079:
            r1 = 1
            goto L_0x006f
        L_0x007b:
            ...
            java.lang.Thread r3 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x008a }
            r3.interrupt()     // Catch:{ all -> 0x008a }
        L_0x0084:
