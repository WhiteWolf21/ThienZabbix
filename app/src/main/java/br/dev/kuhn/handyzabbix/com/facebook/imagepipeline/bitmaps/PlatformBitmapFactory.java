...
public abstract class PlatformBitmapFactory {
    ...
    private static Bitmap.Config getSuitableBitmapConfig(Bitmap bitmap) {
        ...
        int i = C07831.$SwitchMap$android$graphics$Bitmap$Config[config2.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C07831 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory.C07831.<clinit>():void");
        }
    }
