    ...
    static /* synthetic */ class C08601 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imageutils.BitmapUtil.C08601.<clinit>():void");
        }
    }

    public static int getPixelSizeForBitmapConfig(Bitmap.Config config) {
        int i = C08601.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 4;
        }
        if (i == 2) {
