...
public class ReactImageManager extends SimpleViewManager<ReactImageView> {
    ...
    public ReactImageView createViewInstance(ThemedReactContext themedReactContext) {
        ...
        if (reactCallerContextFactory != null) {
            obj = reactCallerContextFactory.getOrCreateCallerContext(themedReactContext.getSurfaceID(), (String) null);
        } else {
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.m127of(ImageLoadEvent.eventNameForType(4), MapBuilder.m123of("registrationName", "onLoadStart"), ImageLoadEvent.eventNameForType(5), MapBuilder.m123of("registrationName", "onProgress"), ImageLoadEvent.eventNameForType(2), MapBuilder.m123of("registrationName", "onLoad"), ImageLoadEvent.eventNameForType(1), MapBuilder.m123of("registrationName", "onError"), ImageLoadEvent.eventNameForType(3), MapBuilder.m123of("registrationName", "onLoadEnd"));
    }
