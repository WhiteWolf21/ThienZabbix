...
/* renamed from: expo.modules.filesystem.FileSystemModule$uploadTaskStartAsync$progressListener$1$moduleRegistry$$inlined$getFromModuleRegistry$1 */
/* compiled from: ModuleRegistryDelegate.kt */
public final class C1713x1b5d3bd5 extends Lambda implements Function0<T> {
    final /* synthetic */ ModuleRegistryDelegate this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C1713x1b5d3bd5(ModuleRegistryDelegate moduleRegistryDelegate) {
        super(0);
