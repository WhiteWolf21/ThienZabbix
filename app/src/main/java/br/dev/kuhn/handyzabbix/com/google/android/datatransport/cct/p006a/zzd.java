...
final class zzd extends zza {
    ...
    /* compiled from: com.google.android.datatransport:transport-backend-cct@@2.2.0 */
    static final class zza extends zza.C2117zza {
        private Integer zza;
        private String zzb;
        private String zzc;
        private String zzd;
        ...
        public zza.C2117zza zza(int i) {
            this.zza = Integer.valueOf(i);
            return this;
        }

        public zza.C2117zza zzb(String str) {
            this.zzh = str;
            return this;
        }

        public zza.C2117zza zzc(String str) {
            this.zzc = str;
            return this;
        }

        public zza.C2117zza zzd(String str) {
            this.zzg = str;
            return this;
        }

        public zza.C2117zza zze(String str) {
            this.zzb = str;
            return this;
        }

        public zza.C2117zza zzf(String str) {
            this.zzf = str;
            return this;
        }

        public zza.C2117zza zzg(String str) {
            this.zze = str;
            return this;
        }

        public zza.C2117zza zza(String str) {
            this.zzd = str;
            return this;
        }
