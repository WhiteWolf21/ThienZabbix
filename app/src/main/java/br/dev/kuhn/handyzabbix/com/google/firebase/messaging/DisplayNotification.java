...
class DisplayNotification {
    ...
    private void showNotification(CommonNotificationBuilder.DisplayNotificationInfo displayNotificationInfo) {
        ...
        ((NotificationManager) this.context.getSystemService(NotificationsService.NOTIFICATION_KEY)).notify(displayNotificationInfo.tag, displayNotificationInfo.f243id, displayNotificationInfo.notificationBuilder.build());
    }
}
