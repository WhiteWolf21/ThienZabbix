...
public class GmsRpc {
    ...
    public GmsRpc(FirebaseApp firebaseApp, Metadata metadata2, UserAgentPublisher userAgentPublisher2, HeartBeatInfo heartBeatInfo, FirebaseInstallationsApi firebaseInstallationsApi) {
        this(firebaseApp, metadata2, new Rpc(firebaseApp.getApplicationContext(), metadata2), userAgentPublisher2, heartBeatInfo, firebaseInstallationsApi);
    }

    GmsRpc(FirebaseApp firebaseApp, Metadata metadata2, Rpc rpc2, UserAgentPublisher userAgentPublisher2, HeartBeatInfo heartBeatInfo, FirebaseInstallationsApi firebaseInstallationsApi) {
