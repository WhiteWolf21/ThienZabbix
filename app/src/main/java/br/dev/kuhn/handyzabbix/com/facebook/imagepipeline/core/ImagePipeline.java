...
public class ImagePipeline {
    ...
    public void clearMemoryCaches() {
        C08024 r0 = new Predicate<CacheKey>() {
    ...
    public boolean isInDiskCacheSync(ImageRequest imageRequest) {
        CacheKey encodedCacheKey = this.mCacheKeyFactory.getEncodedCacheKey(imageRequest, (Object) null);
        int i = C08068.f154x9ce557aa[imageRequest.getCacheChoice().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C08068 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f154x9ce557aa     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.core.ImagePipeline.C08068.<clinit>():void");
        }
    }
