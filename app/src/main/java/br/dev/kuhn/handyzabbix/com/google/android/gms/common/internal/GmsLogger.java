...
public final class GmsLogger {
    ...
    /* renamed from: d */
    public final void mo18870d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzh(str2));
        }
    }
    ...
    /* renamed from: d */
    public final void mo18871d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* renamed from: v */
    public final void mo18879v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzh(str2));
        }
    }
    ...
    /* renamed from: v */
    public final void mo18880v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* renamed from: i */
    public final void mo18875i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzh(str2));
        }
    }
    ...
    /* renamed from: i */
    public final void mo18876i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* renamed from: w */
    public final void mo18881w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzh(str2));
        }
    }
    ...
    /* renamed from: w */
    public final void mo18882w(String str, String str2, Throwable th) {
        if (canLog(5)) {
    ...
    /* renamed from: e */
    public final void mo18872e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzh(str2));
        }
    }
    ...
    /* renamed from: e */
    public final void mo18873e(String str, String str2, Throwable th) {
        if (canLog(6)) {
