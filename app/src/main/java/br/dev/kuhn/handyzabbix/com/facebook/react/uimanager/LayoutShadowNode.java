...
public class LayoutShadowNode extends ReactShadowNodeImpl {
    ...
    private final MutableYogaValue mTempYogaValue = new MutableYogaValue((C11111) null);

    private static class MutableYogaValue {
        YogaUnit unit;
        float value;

        /* synthetic */ MutableYogaValue(C11111 r1) {
            this();
        }
    ...
    public void setWidth(Dynamic dynamic) {
        if (!isVirtual()) {
            ...
            int i = C11111.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
            if (i == 1 || i == 2) {
    ...
    static /* synthetic */ class C11111 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.LayoutShadowNode.C11111.<clinit>():void");
        }
    }
    ...
    public void setMargins(int i, Dynamic dynamic) {
        if (!isVirtual()) {
            ...
            this.mTempYogaValue.setFromDynamic(dynamic);
            int i2 = C11111.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
            if (i2 == 1 || i2 == 2) {
