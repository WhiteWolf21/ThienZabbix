...
public final class RNGestureHandlerRegistry implements GestureHandlerRegistry {
    ...
    public static /* synthetic */ boolean attachHandlerToView$default(RNGestureHandlerRegistry rNGestureHandlerRegistry, int i, int i2, boolean z, int i3, Object obj) {
        if ((i3 & 4) != 0) {
            z = false;
        }
        return rNGestureHandlerRegistry.attachHandlerToView(i, i2, z);
    }

    public final synchronized boolean attachHandlerToView(int i, int i2, boolean z) {
        boolean z2;
        ...
        if (gestureHandler == null) {
            ...
            gestureHandler.setUsesDeviceEvents(z);
    ...
    private final synchronized void registerHandlerForViewWithTag(int i, GestureHandler<?> gestureHandler) {
        if (this.attachedTo.get(gestureHandler.getTag()) == null) {
            ...
            ArrayList arrayList = this.handlersForView.get(i);
            if (arrayList == null) {
        ...
        if (gestureHandler.getView() != null) {
            UiThreadUtil.runOnUiThread(new Runnable() {
                public final void run() {
                    RNGestureHandlerRegistry.m211detachHandler$lambda2(GestureHandler.this);
                }
            });
        }
    }
    ...
    /* renamed from: detachHandler$lambda-2  reason: not valid java name */
    public static final void m211detachHandler$lambda2(GestureHandler gestureHandler) {
        Intrinsics.checkNotNullParameter(gestureHandler, "$handler");
