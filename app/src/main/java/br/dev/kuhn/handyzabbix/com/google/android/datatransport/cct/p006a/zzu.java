...
public final class zzu implements ObjectEncoder<zzi> {
    public void encode(Object obj, Object obj2) throws EncodingException, IOException {
        ...
        if (zzi.zzf() != null) {
            objectEncoderContext.add("sourceExtension", (Object) zzi.zzf());
        }
        if (zzi.zzg() != null) {
            objectEncoderContext.add("sourceExtensionJsonProto3", (Object) zzi.zzg());
        }
        if (zzi.zzd() != Integer.MIN_VALUE) {
            objectEncoderContext.add("eventCode", zzi.zzd());
        }
        if (zzi.zze() != null) {
            objectEncoderContext.add("networkConnectionInfo", (Object) zzi.zze());
        }
    }
}
