...
public class ScrollEvent extends Event<ScrollEvent> {
    ...
    private WritableMap serializeEventData() {
        ...
        createMap.putDouble(ViewProps.TOP, Utils.DOUBLE_EPSILON);
        createMap.putDouble(ViewProps.BOTTOM, Utils.DOUBLE_EPSILON);
        createMap.putDouble(ViewProps.LEFT, Utils.DOUBLE_EPSILON);
        createMap.putDouble(ViewProps.RIGHT, Utils.DOUBLE_EPSILON);
