package br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.model;
...
public class NotificationContent implements Parcelable, Serializable {
    ...
    public static class Builder {
        ...
        public NotificationContent build() {
            ...
            String unused = notificationContent.mTitle = this.mTitle;
            String unused2 = notificationContent.mSubtitle = this.mSubtitle;
            String unused3 = notificationContent.mText = this.mText;
            Number unused4 = notificationContent.mBadgeCount = this.mBadgeCount;
            boolean unused5 = notificationContent.mShouldUseDefaultVibrationPattern = this.mShouldUseDefaultVibrationPattern;
            long[] unused6 = notificationContent.mVibrationPattern = this.mVibrationPattern;
            boolean unused7 = notificationContent.mShouldPlayDefaultSound = this.mShouldPlayDefaultSound;
            Uri unused8 = notificationContent.mSound = this.mSound;
            JSONObject unused9 = notificationContent.mBody = this.mBody;
            NotificationPriority unused10 = notificationContent.mPriority = this.mPriority;
            Number unused11 = notificationContent.mColor = this.mColor;
            boolean unused12 = notificationContent.mAutoDismiss = this.mAutoDismiss;
            String unused13 = notificationContent.mCategoryId = this.mCategoryId;
            boolean unused14 = notificationContent.mSticky = this.mSticky;
