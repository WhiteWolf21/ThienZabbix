...
public class FirebaseApp {
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        componentArr[0] = Component.m166of(context, Context.class, new Class[0]);
        componentArr[1] = Component.m166of(this, FirebaseApp.class, new Class[0]);
        componentArr[2] = Component.m166of(firebaseOptions, FirebaseOptions.class, new Class[0]);
