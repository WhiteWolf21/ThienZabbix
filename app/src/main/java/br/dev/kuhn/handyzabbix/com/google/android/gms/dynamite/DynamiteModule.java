...
public final class DynamiteModule {
    ...
    /*  JADX ERROR: IndexOutOfBoundsException in pass: RegionMakerVisitor
        ...
        */
    /* JADX WARNING: Unknown top exception splitter block from list: {B:23:0x0052=Splitter:B:23:0x0052, B:18:0x0035=Splitter:B:18:0x0035, B:35:0x0079=Splitter:B:35:0x0079} */
    public static int zza(android.content.Context r8, java.lang.String r9, boolean r10) {
        /*
            java.lang.Class<com.google.android.gms.dynamite.DynamiteModule> r0 = com.google.android.gms.dynamite.DynamiteModule.class
            monitor-enter(r0)     // Catch:{ all -> 0x00ee }
            java.lang.Boolean r1 = zzif     // Catch:{ all -> 0x00eb }
            if (r1 != 0) goto L_0x00b8
            android.content.Context r1 = r8.getApplicationContext()     // Catch:{ ClassNotFoundException -> 0x008f, IllegalAccessException -> 0x008d, NoSuchFieldException -> 0x008b }
            java.lang.ClassLoader r1 = r1.getClassLoader()     // Catch:{ ClassNotFoundException -> 0x008f, IllegalAccessException -> 0x008d, NoSuchFieldException -> 0x008b }
            java.lang.Class<com.google.android.gms.dynamite.DynamiteModule$DynamiteLoaderClassLoader> r2 = com.google.android.gms.dynamite.DynamiteModule.DynamiteLoaderClassLoader.class
            java.lang.String r2 = r2.getName()     // Catch:{ ClassNotFoundException -> 0x008f, IllegalAccessException -> 0x008d, NoSuchFieldException -> 0x008b }
            java.lang.Class r1 = r1.loadClass(r2)     // Catch:{ ClassNotFoundException -> 0x008f, IllegalAccessException -> 0x008d, NoSuchFieldException -> 0x008b }
            java.lang.String r2 = "sClassLoader"
            java.lang.reflect.Field r2 = r1.getDeclaredField(r2)     // Catch:{ ClassNotFoundException -> 0x008f, IllegalAccessException -> 0x008d, NoSuchFieldException -> 0x008b }
            monitor-enter(r1)     // Catch:{ ClassNotFoundException -> 0x008f, IllegalAccessException -> 0x008d, NoSuchFieldException -> 0x008b }
            r3 = 0
            java.lang.Object r4 = r2.get(r3)     // Catch:{ all -> 0x0088 }
            java.lang.ClassLoader r4 = (java.lang.ClassLoader) r4     // Catch:{ all -> 0x0088 }
            if (r4 == 0) goto L_0x0038
            java.lang.ClassLoader r2 = java.lang.ClassLoader.getSystemClassLoader()     // Catch:{ all -> 0x0088 }
            if (r4 != r2) goto L_0x0032
            java.lang.Boolean r2 = java.lang.Boolean.FALSE     // Catch:{ all -> 0x0088 }
            goto L_0x0085
        L_0x0032:
            zza(r4)     // Catch:{ LoadingException -> 0x0035 }
        L_0x0035:
            java.lang.Boolean r2 = java.lang.Boolean.TRUE     // Catch:{ all -> 0x0088 }
            goto L_0x0085
        L_0x0038:
            java.lang.String r4 = "com.google.android.gms"
            android.content.Context r5 = r8.getApplicationContext()     // Catch:{ all -> 0x0088 }
            java.lang.String r5 = r5.getPackageName()     // Catch:{ all -> 0x0088 }
            boolean r4 = r4.equals(r5)     // Catch:{ all -> 0x0088 }
            if (r4 == 0) goto L_0x0052
            java.lang.ClassLoader r4 = java.lang.ClassLoader.getSystemClassLoader()     // Catch:{ all -> 0x0088 }
            r2.set(r3, r4)     // Catch:{ all -> 0x0088 }
            java.lang.Boolean r2 = java.lang.Boolean.FALSE     // Catch:{ all -> 0x0088 }
            goto L_0x0085
        L_0x0052:
        ...
        L_0x0088:
            r2 = move-exception
            monitor-exit(r1)     // Catch:{ all -> 0x0088 }
            throw r2     // Catch:{ ClassNotFoundException -> 0x008f, IllegalAccessException -> 0x008d, NoSuchFieldException -> 0x008b }
        L_0x008b:
            r1 = move-exception
            goto L_0x0090
        L_0x008d:
        ...
        L_0x0090:
            ...
            java.lang.String r1 = java.lang.String.valueOf(r1)     // Catch:{ all -> 0x00eb }
            java.lang.String r3 = java.lang.String.valueOf(r1)     // Catch:{ all -> 0x00eb }
            ...
            java.lang.String r1 = r4.toString()     // Catch:{ all -> 0x00eb }
            android.util.Log.w(r2, r1)     // Catch:{ all -> 0x00eb }
            java.lang.Boolean r1 = java.lang.Boolean.FALSE     // Catch:{ all -> 0x00eb }
        L_0x00b6:
            zzif = r1     // Catch:{ all -> 0x00eb }
        L_0x00b8:
            monitor-exit(r0)     // Catch:{ all -> 0x00eb }
            boolean r0 = r1.booleanValue()     // Catch:{ all -> 0x00ee }
            if (r0 == 0) goto L_0x00e6
            int r8 = zzc(r8, r9, r10)     // Catch:{ LoadingException -> 0x00c4 }
            return r8
        L_0x00c4:
            r9 = move-exception
            java.lang.String r10 = "DynamiteModule"
            java.lang.String r0 = "Failed to retrieve remote module version: "
            java.lang.String r9 = r9.getMessage()     // Catch:{ all -> 0x00ee }
            java.lang.String r9 = java.lang.String.valueOf(r9)     // Catch:{ all -> 0x00ee }
            int r1 = r9.length()     // Catch:{ all -> 0x00ee }
            if (r1 == 0) goto L_0x00dc
            java.lang.String r9 = r0.concat(r9)     // Catch:{ all -> 0x00ee }
            goto L_0x00e1
        L_0x00dc:
            java.lang.String r9 = new java.lang.String     // Catch:{ all -> 0x00ee }
            r9.<init>(r0)     // Catch:{ all -> 0x00ee }
        L_0x00e1:
            android.util.Log.w(r10, r9)     // Catch:{ all -> 0x00ee }
            r8 = 0
            return r8
        L_0x00e6:
            int r8 = zzb((android.content.Context) r8, (java.lang.String) r9, (boolean) r10)     // Catch:{ all -> 0x00ee }
            return r8
        L_0x00eb:
            r9 = move-exception
            monitor-exit(r0)     // Catch:{ all -> 0x00eb }
