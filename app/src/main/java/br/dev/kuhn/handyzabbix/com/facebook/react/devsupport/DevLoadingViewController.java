...
public class DevLoadingViewController {
    ...
    public DevLoadingViewController(ReactInstanceManagerDevHelper reactInstanceManagerDevHelper) {
    ...
    public void showForUrl(String str) {
        ...
        if (context != null) {
            try {
                URL url = new URL(str);
                int i = C0873R.string.catalyst_loading_from_url;
                showMessage(context.getString(i, new Object[]{url.getHost() + ":" + url.getPort()}));
            } catch (MalformedURLException e) {
                FLog.m48e(ReactConstants.TAG, "Bundle url format is invalid. \n\n" + e.toString());
            }
        }
    }
    ...
    public void showForRemoteJSEnabled() {
        Context context = getContext();
        if (context != null) {
            showMessage(context.getString(C0873R.string.catalyst_debug_connecting));
        }
    }
    ...
    public void showInternal(String str) {
        ...
        if (popupWindow == null || !popupWindow.isShowing()) {
            ...
            int i = rect.top;
            TextView textView = (TextView) ((LayoutInflater) currentActivity.getSystemService("layout_inflater")).inflate(C0873R.layout.dev_loading_view, (ViewGroup) null);
