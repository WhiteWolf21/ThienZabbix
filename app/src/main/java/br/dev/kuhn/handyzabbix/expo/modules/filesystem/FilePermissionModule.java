...
public class FilePermissionModule implements FilePermissionModuleInterface, InternalModule {
    ...
    public EnumSet<Permission> getPathPermissions(Context context, String str) {
        ...
        return internalPathPermissions != null ? internalPathPermissions : getExternalPathPermissions(str);
    }
    ...
    private final EnumSet<Permission> getInternalPathPermissions(String str, Context context) {
        ...
        try {
            ...
            while (true) {
                ...
                boolean z = false;
                if (StringsKt.startsWith$default(canonicalPath, str2 + IOUtils.DIR_SEPARATOR_UNIX, false, 2, (Object) null) || Intrinsics.areEqual((Object) str2, (Object) canonicalPath)) {
                    z = true;
                    continue;
                }
                if (z) {
    ...
    public EnumSet<Permission> getExternalPathPermissions(String str) {
        ...
        Intrinsics.checkNotNullExpressionValue(noneOf, "EnumSet.noneOf(Permissio…sion.WRITE)\n      }\n    }");
        return noneOf;
    }
    ...
    private final List<String> getInternalPaths(Context context) throws IOException {
        ...
        return CollectionsKt.listOf(filesDir.getCanonicalPath(), cacheDir.getCanonicalPath());
    }
}
