...
public final class zzw implements ObjectEncoder<zzk> {
    public void encode(Object obj, Object obj2) throws EncodingException, IOException {
        ...
        if (zzk.zzb() != null) {
            objectEncoderContext.add("clientInfo", (Object) zzk.zzb());
        }
        if (zzk.zze() != null) {
            objectEncoderContext.add("logSourceName", (Object) zzk.zze());
        ...
        if (!zzk.zzc().isEmpty()) {
            objectEncoderContext.add("logEvent", (Object) zzk.zzc());
        }
    }
}
