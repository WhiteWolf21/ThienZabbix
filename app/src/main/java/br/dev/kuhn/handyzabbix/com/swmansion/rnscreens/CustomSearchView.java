...
public final class CustomSearchView extends SearchView {
    ...
    public CustomSearchView(Context context, Fragment fragment) {
        ...
        OnBackPressedCallback customSearchView$mOnBackPressedCallback$1 = new CustomSearchView$mOnBackPressedCallback$1(this, true);
