package br.dev.kuhn.handyzabbix.expo.modules.adapters.react.views;
...
import br.dev.kuhn.handyzabbix.expo.modules.adapters.react.ArgumentsHelper;
    ...
    static Map<String, Object> getExportedCustomDirectEventTypeConstants(ViewManager viewManager) {
        ...
        for (String next : viewManager.getExportedEventNames()) {
            if (next instanceof String) {
                builder.put(next, MapBuilder.m123of("registrationName", next));
            }
        }
