...
/* renamed from: expo.modules.keepawake.ExpoKeepAwakeManager$moduleRegistry$$inlined$getFromModuleRegistry$2 */
/* compiled from: ModuleRegistryDelegate.kt */
public final class C1724xb78f1090 extends Lambda implements Function0<T> {
    final /* synthetic */ ModuleRegistryDelegate this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C1724xb78f1090(ModuleRegistryDelegate moduleRegistryDelegate) {
        super(0);
