...
public class ReactViewBackgroundDrawable extends Drawable {
    ...
    static /* synthetic */ class C11701 {
        ...
        static final /* synthetic */ int[] f173xe6ea8768;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f173xe6ea8768     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f173xe6ea8768     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.views.view.ReactViewBackgroundDrawable.C11701.<clinit>():void");
        }
    }
    ...
    private enum BorderStyle {
        ...
        public static PathEffect getPathEffect(BorderStyle borderStyle, float f) {
            int i = C11701.f173xe6ea8768[borderStyle.ordinal()];
            if (i == 2) {
                float f2 = f * 3.0f;
    ...
    private void updatePath() {
        ...
        if (this.mNeedUpdatePathForBorderRadius) {
            ...
            RectF rectF3 = rectF;
            float f12 = max5;
            fArr[0] = Math.max(f - (rectF3.left * 0.5f), rectF3.left > 0.0f ? f / rectF3.left : 0.0f);
            fArr[1] = Math.max(f - (rectF3.top * 0.5f), rectF3.top > 0.0f ? f / rectF3.top : 0.0f);
