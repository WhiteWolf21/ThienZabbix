...
public class SafeAreaProviderManager extends ViewGroupManager<SafeAreaProvider> {
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.builder().put("topInsetsChange", MapBuilder.m123of("registrationName", "onInsetsChange")).build();
    }
    ...
    private Map<String, Object> getInitialWindowMetrics() {
        ...
        return MapBuilder.m124of("insets", SerializationUtils.edgeInsetsToJavaMap(safeAreaInsets), TypedValues.Attributes.S_FRAME, SerializationUtils.rectToJavaMap(frame));
    }

    public Map<String, Object> getExportedViewConstants() {
        return MapBuilder.m123of("initialWindowMetrics", getInitialWindowMetrics());
    }
}
