...
class RedBoxDialog extends Dialog implements AdapterView.OnItemClickListener {
    ...
    private static class StackAdapter extends BaseAdapter {
        ...
        private static class FrameViewHolder {
            ...
            private FrameViewHolder(View view) {
                this.mMethodView = (TextView) view.findViewById(C0873R.C0876id.rn_frame_method);
                this.mFileView = (TextView) view.findViewById(C0873R.C0876id.rn_frame_file);
            }
        }
        ...
        public android.view.View getView(int r3, android.view.View r4, android.view.ViewGroup r5) {
            ...
            L_0x0008:
                ...
                int r4 = com.facebook.react.C0873R.layout.redbox_item_title
            ...
            L_0x002b:
                ...
                int r1 = com.facebook.react.C0873R.layout.redbox_item_frame
    ...
    private static class OpenStackFrameTask extends AsyncTask<StackFrame, Void, Void> {
        ...
        private static JSONObject stackFrameToJson(StackFrame stackFrame) {
            return new JSONObject(MapBuilder.m126of(UriUtil.LOCAL_FILE_SCHEME, stackFrame.getFile(), "methodName", stackFrame.getMethod(), StackTraceHelper.LINE_NUMBER_KEY, Integer.valueOf(stackFrame.getLine()), StackTraceHelper.COLUMN_KEY, Integer.valueOf(stackFrame.getColumn())));
        }
    }

    protected RedBoxDialog(Context context, DevSupportManager devSupportManager, RedBoxHandler redBoxHandler) {
        super(context, C0873R.style.Theme_Catalyst_RedBox);
        requestWindowFeature(1);
        setContentView(C0873R.layout.redbox_view);
        this.mDevSupportManager = devSupportManager;
        this.mDoubleTapReloadRecognizer = new DoubleTapReloadRecognizer();
        this.mRedBoxHandler = redBoxHandler;
        ListView listView = (ListView) findViewById(C0873R.C0876id.rn_redbox_stack);
        this.mStackView = listView;
        listView.setOnItemClickListener(this);
        Button button = (Button) findViewById(C0873R.C0876id.rn_redbox_reload_button);
        ...
        Button button2 = (Button) findViewById(C0873R.C0876id.rn_redbox_dismiss_button);
        ...
        if (redBoxHandler != null && redBoxHandler.isReportEnabled()) {
            this.mLoadingIndicator = (ProgressBar) findViewById(C0873R.C0876id.rn_redbox_loading_indicator);
            this.mLineSeparator = findViewById(C0873R.C0876id.rn_redbox_line_separator);
            TextView textView = (TextView) findViewById(C0873R.C0876id.rn_redbox_report_label);
            this.mReportTextView = textView;
            textView.setMovementMethod(LinkMovementMethod.getInstance());
            this.mReportTextView.setHighlightColor(0);
            Button button3 = (Button) findViewById(C0873R.C0876id.rn_redbox_report_button);
