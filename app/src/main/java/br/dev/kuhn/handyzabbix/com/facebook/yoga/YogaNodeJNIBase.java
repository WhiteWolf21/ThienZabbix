...
public abstract class YogaNodeJNIBase extends YogaNode implements Cloneable {
    ...
    static /* synthetic */ class C11801 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.yoga.YogaNodeJNIBase.C11801.<clinit>():void");
        }
    }
    ...
    public float getLayoutMargin(YogaEdge yogaEdge) {
        ...
        switch (C11801.$SwitchMap$com$facebook$yoga$YogaEdge[yogaEdge.ordinal()]) {
            case 1:
                return this.arr[6];
            case 2:
                return this.arr[7];
