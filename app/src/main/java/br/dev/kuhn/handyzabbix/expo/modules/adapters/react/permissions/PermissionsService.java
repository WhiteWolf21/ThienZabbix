...
import br.dev.kuhn.handyzabbix.expo.modules.interfaces.permissions.PermissionsStatus;
        ...
        if (currentActivity instanceof PermissionAwareActivity) {
            synchronized (this) {
                if (this.mCurrentPermissionListener != null) {
                    Boolean.valueOf(this.mPendingPermissionCalls.add(TuplesKt.m176to(strArr, permissionsResponseListener)));
                } else {
