...
import p005br.dev.kuhn.handyzabbix.graphs.constants.CalcFncConstant;
import p005br.dev.kuhn.handyzabbix.graphs.constants.DrawTypeConstant;
...
class TimePickerClockPresenter implements ClockHandView.OnRotateListener, TimePickerView.OnSelectionChange, TimePickerView.OnPeriodChangeListener, ClockHandView.OnActionUpListener, TimePickerPresenter {
    ...
    private static final String[] HOUR_CLOCK_VALUES = {"12", "1", "2", DrawTypeConstant.DOT, "4", DrawTypeConstant.GRADIENT_LINE, "6", CalcFncConstant.ALL_VALUES, "8", CalcFncConstant.LAST_VALUE, "10", "11"};
    private static final String[] MINUTE_CLOCK_VALUES = {"00", DrawTypeConstant.GRADIENT_LINE, "10", "15", "20", "25", "30", "35", "40", "45", "50", "55"};
    ...
    public void setSelection(int i, boolean z) {
        ...
        timePickerView2.setValues(strArr, z2 ? C1242R.string.material_minute_suffix : C1242R.string.material_hour_suffix);
        ...
        timePickerView3.setMinuteHourDelegate(new ClickActionDelegate(timePickerView3.getContext(), C1242R.string.material_hour_selection));
        TimePickerView timePickerView4 = this.timePickerView;
        timePickerView4.setHourClickDelegate(new ClickActionDelegate(timePickerView4.getContext(), C1242R.string.material_minute_selection));
    }
