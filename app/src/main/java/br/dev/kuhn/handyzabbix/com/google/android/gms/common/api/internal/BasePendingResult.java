...
public abstract class BasePendingResult<R extends Result> extends PendingResult<R> {
    ...
    public void cancel() {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r2.zadw     // Catch:{ all -> 0x0028 }
            if (r1 != 0) goto L_0x0026
            boolean r1 = r2.zadv     // Catch:{ all -> 0x0028 }
            if (r1 == 0) goto L_0x000c
            goto L_0x0026
        L_0x000c:
            com.google.android.gms.common.internal.ICancelToken r1 = r2.zady     // Catch:{ all -> 0x0028 }
            if (r1 == 0) goto L_0x0013
            r1.cancel()     // Catch:{ RemoteException -> 0x0013 }
        L_0x0013:
            R r1 = r2.zacj     // Catch:{ all -> 0x0028 }
            zab((com.google.android.gms.common.api.Result) r1)     // Catch:{ all -> 0x0028 }
            r1 = 1
            r2.zadw = r1     // Catch:{ all -> 0x0028 }
