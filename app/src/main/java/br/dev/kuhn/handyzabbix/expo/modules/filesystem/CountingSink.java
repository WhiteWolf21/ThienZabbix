...
final class CountingSink extends ForwardingSink {
    ...
    public void write(Buffer buffer, long j) {
        Intrinsics.checkNotNullParameter(buffer, Constants.ScionAnalytics.PARAM_SOURCE);
