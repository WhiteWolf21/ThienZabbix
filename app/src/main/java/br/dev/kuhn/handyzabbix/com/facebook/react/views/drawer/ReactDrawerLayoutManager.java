...
public class ReactDrawerLayoutManager extends ViewGroupManager<ReactDrawerLayout> implements AndroidDrawerLayoutManagerInterface<ReactDrawerLayout> {
    ...
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m124of("openDrawer", 1, "closeDrawer", 2);
    }
    ...
    public Map getExportedViewConstants() {
        return MapBuilder.m123of("DrawerPosition", MapBuilder.m124of("Left", Integer.valueOf(GravityCompat.START), "Right", Integer.valueOf(GravityCompat.END)));
    }

    public Map getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.m126of(DrawerSlideEvent.EVENT_NAME, MapBuilder.m123of("registrationName", "onDrawerSlide"), DrawerOpenedEvent.EVENT_NAME, MapBuilder.m123of("registrationName", "onDrawerOpen"), DrawerClosedEvent.EVENT_NAME, MapBuilder.m123of("registrationName", "onDrawerClose"), DrawerStateChangedEvent.EVENT_NAME, MapBuilder.m123of("registrationName", "onDrawerStateChanged"));
    }
