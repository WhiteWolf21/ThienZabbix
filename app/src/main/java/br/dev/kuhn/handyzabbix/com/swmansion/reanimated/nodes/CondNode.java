...
public class CondNode extends Node {
    ...
    public Object evaluate() {
        ...
        return (!(nodeValue instanceof Number) || ((Number) nodeValue).doubleValue() == Utils.DOUBLE_EPSILON) ? this.mElseBlockID != -1 ? this.mNodesManager.getNodeValue(this.mElseBlockID) : ZERO : this.mIfBlockID != -1 ? this.mNodesManager.getNodeValue(this.mIfBlockID) : ZERO;
    }
}
