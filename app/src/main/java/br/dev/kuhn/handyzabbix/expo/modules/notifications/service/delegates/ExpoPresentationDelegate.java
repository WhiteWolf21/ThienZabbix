...
import br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.enums.NotificationPriority;
...
import br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.presentation.builders.CategoryAwareNotificationBuilder;
import br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.presentation.builders.ExpoNotificationBuilder;
import br.dev.kuhn.handyzabbix.expo.modules.notifications.service.NotificationsService;
import br.dev.kuhn.handyzabbix.expo.modules.notifications.service.interfaces.PresentationDelegate;
...
public class ExpoPresentationDelegate implements PresentationDelegate {
    ...
    public static final class Companion {
        ...
        public final Pair<String, Integer> parseNotificationIdentifier(String str) {
            ...
            try {
                ...
                Intrinsics.checkNotNullExpressionValue(parse, "parsedIdentifier");
                ...
                Intrinsics.checkNotNullExpressionValue(queryParameter2, "parsedIdentifier.getQuer…RNAL_IDENTIFIER_ID_KEY)!!");
                return new Pair<>(queryParameter, Integer.valueOf(Integer.parseInt(queryParameter2)));
            } catch (NullPointerException e) {
                Log.e(ExpoPresentationDelegate.INTERNAL_IDENTIFIER_SCHEME, "Malformed foreign notification identifier: " + str, e);
                return null;
        ...
        public final String getInternalIdentifierKey(StatusBarNotification statusBarNotification) {
            ...
            Intrinsics.checkNotNullExpressionValue(builder, "with(Uri.parse(\"$INTERNA…  this.toString()\n      }");
            return builder;
        }
    }
    ...
    public void presentNotification(Notification notification, NotificationBehavior notificationBehavior) {
        ...
        if (notificationBehavior == null || notificationBehavior.shouldShowAlert()) {
            ...
            from.notify(notificationRequest.getIdentifier(), getNotifyId(notification.getNotificationRequest()), createNotification(notification, notificationBehavior));
            ...
            Intrinsics.checkNotNullExpressionValue(notificationRequest2, "notification.notificationRequest");
            NotificationContent content = notificationRequest2.getContent();
            Intrinsics.checkNotNullExpressionValue(content, "notification.notificationRequest.content");
    ...
    public void dismissNotifications(Collection<String> collection) {
        ...
        for (String str : collection) {
            ...
            if (parseNotificationIdentifier != null) {
                ...
                Intrinsics.checkNotNullExpressionValue(obj2, "foreignNotification.second");
                ...
                while (true) {
                    ...
                    obj = it.next();
                    NotificationRequest notificationRequest2 = ((Notification) obj).getNotificationRequest();
                    Intrinsics.checkNotNullExpressionValue(notificationRequest2, "it.notificationRequest");
                    if (Intrinsics.areEqual((Object) notificationRequest2.getIdentifier(), (Object) str)) {
                        break;
                    }
                }
    ...
    public android.app.Notification createNotification(Notification notification, NotificationBehavior notificationBehavior) {
        ...
        Intrinsics.checkNotNullExpressionValue(build, "CategoryAwareNotificatio…onBehavior)\n    }.build()");
        return build;
    }
    ...
    public Notification getNotification(StatusBarNotification statusBarNotification) {
        ...
        if (byteArray != null) {
            try {
                ...
                Intrinsics.checkNotNullExpressionValue(createFromParcel, "NotificationRequest.CREATOR.createFromParcel(this)");
                obtain.recycle();
        ...
        Intrinsics.checkNotNullExpressionValue(bundle, "notification.extras");
