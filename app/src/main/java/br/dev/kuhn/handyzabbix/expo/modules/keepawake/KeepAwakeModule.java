...
public final class KeepAwakeModule extends ExportedModule {
    ...
    private final KeepAwakeManager getKeepAwakeManager() {
        return (KeepAwakeManager) this.keepAwakeManager$delegate.getValue();
    }
    ...
    public KeepAwakeModule(Context context, ModuleRegistryDelegate moduleRegistryDelegate2) {
        ...
        this.keepAwakeManager$delegate = LazyKt.lazy(new KeepAwakeModule$$special$$inlined$moduleRegistry$1(this.moduleRegistryDelegate));
    }
    ...
    private final /* synthetic */ <T> Lazy<T> moduleRegistry() {
        ...
        return LazyKt.lazy(new KeepAwakeModule$moduleRegistry$$inlined$getFromModuleRegistry$1(access$getModuleRegistryDelegate$p));
    }
    ...
    public final void activate(String str, Promise promise) {
        ...
        try {
            getKeepAwakeManager().activate(str, new KeepAwakeModule$activate$1(promise));
    ...
    public final void deactivate(String str, Promise promise) {
        ...
        Intrinsics.checkNotNullParameter(promise, BaseJavaModule.METHOD_TYPE_PROMISE);
        try {
            getKeepAwakeManager().deactivate(str, new KeepAwakeModule$deactivate$1(promise));
        } catch (CurrentActivityNotFoundException unused) {
