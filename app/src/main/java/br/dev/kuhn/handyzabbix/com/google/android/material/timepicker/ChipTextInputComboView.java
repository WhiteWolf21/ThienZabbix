...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        Chip chip2 = (Chip) from.inflate(C1242R.layout.material_time_chip, this, false);
        this.chip = chip2;
        TextInputLayout textInputLayout2 = (TextInputLayout) from.inflate(C1242R.layout.material_time_input, this, false);
        ...
        this.label = (TextView) findViewById(C1242R.C1246id.material_label);
