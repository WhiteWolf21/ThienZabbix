    ...
    static /* synthetic */ class C16871 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: expo.modules.adapters.react.ArgumentsHelper.C16871.<clinit>():void");
        }
    }

    public static Object getNativeArgumentForExpectedClass(Dynamic dynamic, Class<?> cls) {
        switch (C16871.$SwitchMap$com$facebook$react$bridge$ReadableType[dynamic.getType().ordinal()]) {
            case 1:
