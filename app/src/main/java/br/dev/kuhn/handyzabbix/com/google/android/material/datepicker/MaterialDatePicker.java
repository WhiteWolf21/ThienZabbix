...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C1242R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, (AttributeSet) null, C1242R.attr.materialCalendarStyle, C1242R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(this.fullscreen ? C1242R.layout.mtrl_picker_fullscreen : C1242R.layout.mtrl_picker_dialog, viewGroup);
        Context context = inflate.getContext();
        if (this.fullscreen) {
            inflate.findViewById(C1242R.C1246id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View findViewById = inflate.findViewById(C1242R.C1246id.mtrl_calendar_main_pane);
            View findViewById2 = inflate.findViewById(C1242R.C1246id.mtrl_calendar_frame);
        ...
        TextView textView = (TextView) inflate.findViewById(C1242R.C1246id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) inflate.findViewById(C1242R.C1246id.mtrl_picker_header_toggle);
        TextView textView2 = (TextView) inflate.findViewById(C1242R.C1246id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) inflate.findViewById(C1242R.C1246id.confirm_button);
        ...
        Button button = (Button) inflate.findViewById(C1242R.C1246id.cancel_button);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C1242R.string.mtrl_picker_announce_current_selection), new Object[]{headerText}));
    ...
    public void startPickerFragment() {
        ...
        beginTransaction.replace(C1242R.C1246id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateToggleContentDescription(CheckableImageButton checkableImageButton) {
        ...
        if (this.headerToggleButton.isChecked()) {
            str = checkableImageButton.getContext().getString(C1242R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            str = checkableImageButton.getContext().getString(C1242R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C1242R.C1245drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C1242R.C1245drawable.material_ic_edit_black_24dp));
    ...
    static boolean isNestedScrollable(Context context) {
        return readMaterialCalendarStyleBoolean(context, C1242R.attr.nestedScrollable);
    }

    static boolean readMaterialCalendarStyleBoolean(Context context, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C1242R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i});
    ...
    private static int getDialogPickerHeight(Context context) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C1242R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C1242R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C1242R.dimen.mtrl_calendar_navigation_bottom_padding);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C1242R.dimen.mtrl_calendar_days_of_week_height);
        return dimensionPixelSize + dimensionPixelSize2 + (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C1242R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C1242R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C1242R.dimen.mtrl_calendar_bottom_padding);
    }
    ...
    private static int getPaddedPickerWidth(Context context) {
        ...
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C1242R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C1242R.dimen.mtrl_calendar_month_horizontal_padding));
    }
