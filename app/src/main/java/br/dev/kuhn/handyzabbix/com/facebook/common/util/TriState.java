    ...
    static /* synthetic */ class C07381 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.common.util.TriState.C07381.<clinit>():void");
        }
    }

    public boolean asBoolean() {
        int i = C07381.$SwitchMap$com$facebook$common$util$TriState[ordinal()];
        if (i == 1) {
            return true;
        }
        if (i == 2) {
