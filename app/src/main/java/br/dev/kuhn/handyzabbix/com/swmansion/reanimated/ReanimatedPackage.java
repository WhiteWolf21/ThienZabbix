...
public class ReanimatedPackage extends TurboReactPackage {
    ...
    private UIManagerModule createUIManager(ReactApplicationContext reactApplicationContext) {
        ...
        try {
            return new ReanimatedUIManager(reactApplicationContext, ((ReactApplication) reactApplicationContext.getApplicationContext()).getReactNativeHost().getReactInstanceManager().getOrCreateViewManagers(reactApplicationContext), -1);
        } finally {
