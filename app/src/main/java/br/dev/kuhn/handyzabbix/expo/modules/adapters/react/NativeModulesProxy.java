...
public class NativeModulesProxy extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        ...
        hashMap2.putAll(this.mKotlinInteropModuleRegistry.exportMethods(new Function2() {
            public final Object invoke(Object obj, Object obj2) {
                return NativeModulesProxy.this.lambda$getConstants$0$NativeModulesProxy((String) obj, (List) obj2);
            }
        }));
        for (ViewManager name2 : allViewManagers) {
            arrayList.add(name2.getName());
        }
        arrayList.addAll(this.mKotlinInteropModuleRegistry.exportedViewManagersNames());
    ...
    public /* synthetic */ Unit lambda$getConstants$0$NativeModulesProxy(String str, List list) {
