...
public class ReactPicker extends AppCompatSpinner {
    ...
    private void setSpinnerBackground() {
        setBackgroundResource(C1588R.C1590drawable.spinner_dropdown_background);
    ...
    public void setDropdownIconColor(@Nullable int i) {
        ((RippleDrawable) ((LayerDrawable) getBackground()).findDrawableByLayerId(C1588R.C1591id.dropdown_icon)).setColorFilter(i, PorterDuff.Mode.SRC_ATOP);
    }

    public void setDropdownIconRippleColor(@Nullable int i) {
        ((RippleDrawable) ((LayerDrawable) getBackground()).findDrawableByLayerId(C1588R.C1591id.dropdown_icon)).setColor(ColorStateList.valueOf(i));
    }

    public void setBackgroundColor(@Nullable int i) {
        ((GradientDrawable) ((LayerDrawable) getBackground()).findDrawableByLayerId(C1588R.C1591id.dropdown_background)).setColor(i);
    }
