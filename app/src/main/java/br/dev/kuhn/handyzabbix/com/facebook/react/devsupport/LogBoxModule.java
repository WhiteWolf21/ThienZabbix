            ...
            public void run() {
                if (LogBoxModule.this.mReactRootView == null && LogBoxModule.this.mDevSupportManager != null) {
                    ...
                    if (LogBoxModule.this.mReactRootView == null) {
                        RNLog.m132e("Unable to launch logbox because react was unable to create the root view");
                    }
                }
            }
        });
                ...
                public void run() {
                    if (LogBoxModule.this.mLogBoxDialog == null && LogBoxModule.this.mReactRootView != null) {
                        ...
                        if (access$300 == null || access$300.isFinishing()) {
                            RNLog.m132e("Unable to launch logbox because react activity is not available, here is the error that logbox would've displayed: ");
                            return;
                        }
