...
final class zaa implements PendingResult.StatusListener {
    ...
    public final void onComplete(com.google.android.gms.common.api.Status r5) {
        /*
            ...
            monitor-enter(r0)
            com.google.android.gms.common.api.Batch r1 = r4.zabd     // Catch:{ all -> 0x0066 }
        ...
        L_0x0011:
            ...
            com.google.android.gms.common.api.Batch r5 = r4.zabd     // Catch:{ all -> 0x0066 }
            boolean unused = r5.zabb = true     // Catch:{ all -> 0x0066 }
            goto L_0x0029
        L_0x001e:
            boolean r5 = r5.isSuccess()     // Catch:{ all -> 0x0066 }
            if (r5 != 0) goto L_0x0029
            com.google.android.gms.common.api.Batch r5 = r4.zabd     // Catch:{ all -> 0x0066 }
            boolean unused = r5.zaba = true     // Catch:{ all -> 0x0066 }
        L_0x0029:
            com.google.android.gms.common.api.Batch r5 = r4.zabd     // Catch:{ all -> 0x0066 }
            com.google.android.gms.common.api.Batch.zab(r5)     // Catch:{ all -> 0x0066 }
            com.google.android.gms.common.api.Batch r5 = r4.zabd     // Catch:{ all -> 0x0066 }
            int r5 = r5.zaaz     // Catch:{ all -> 0x0066 }
            if (r5 != 0) goto L_0x0064
            com.google.android.gms.common.api.Batch r5 = r4.zabd     // Catch:{ all -> 0x0066 }
            boolean r5 = r5.zabb     // Catch:{ all -> 0x0066 }
            if (r5 == 0) goto L_0x0044
            com.google.android.gms.common.api.Batch r5 = r4.zabd     // Catch:{ all -> 0x0066 }
            com.google.android.gms.common.api.zaa.super.cancel()     // Catch:{ all -> 0x0066 }
            goto L_0x0064
        L_0x0044:
            com.google.android.gms.common.api.Batch r5 = r4.zabd     // Catch:{ all -> 0x0066 }
            boolean r5 = r5.zaba     // Catch:{ all -> 0x0066 }
        ...
        L_0x0056:
            ...
            com.google.android.gms.common.api.PendingResult[] r3 = r1.zabc     // Catch:{ all -> 0x0066 }
