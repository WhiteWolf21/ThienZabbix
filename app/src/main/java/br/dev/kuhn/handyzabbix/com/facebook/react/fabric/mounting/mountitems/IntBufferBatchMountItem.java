...
public class IntBufferBatchMountItem implements MountItem {
    ...
    public void execute(MountingManager mountingManager) {
        ...
        int i4;
        int i5;
        MountingManager mountingManager2 = mountingManager;
        if (this.mContext == null) {
            String str = TAG;
            FLog.m50e(str, "Cannot execute batch of %s MountItems; no context. Hopefully this is because StopSurface was called.", str);
            return;
        }
        ...
        while (i6 < this.mIntBufferLen) {
            ...
            for (int i13 = 0; i13 < i; i13++) {
                if (i10 == 2) {
                    ...
                    mountingManager2.deleteView(this.mIntBuffer[i6]);
                    i6++;
                } else {
                    if (i10 == 8) {
                        ...
                        int i20 = i19 + 1;
                        i5 = i20 + 1;
                        mountingManager2.addViewAt(iArr2[i19], iArr2[i6], iArr2[i20]);
                    } else if (i10 == 16) {
                        int[] iArr3 = this.mIntBuffer;
                        int i21 = i6 + 1;
                        int i22 = i21 + 1;
                        i5 = i22 + 1;
                        mountingManager2.removeViewAt(iArr3[i6], iArr3[i21], iArr3[i22]);
                    } else {
                        if (i10 == 32) {
                            i2 = i6 + 1;
                            i3 = i12 + 1;
                            mountingManager2.updateProps(this.mIntBuffer[i6], castToProps(this.mObjBuffer[i12]));
                        } else if (i10 == 64) {
                            i2 = i6 + 1;
                            i3 = i12 + 1;
                            mountingManager2.updateState(this.mIntBuffer[i6], castToState(this.mObjBuffer[i12]));
                        } else {
                            if (i10 == 128) {
                                ...
                                i2 = i6 + 1;
                                i3 = i12 + 1;
                                mountingManager2.updateEventEmitter(this.mIntBuffer[i6], castToEventEmitter(this.mObjBuffer[i12]));
                            } else {
                ...
                while (true) {
                    if (i9 < i) {
                        if (i8 == 2) {
                            int i10 = i4 + 1;
                            i2 = i10 + 1;
                            sb.append(String.format("CREATE [%d] - layoutable:%d - %s\n", new Object[]{Integer.valueOf(this.mIntBuffer[i4]), Integer.valueOf(this.mIntBuffer[i10]), FabricComponents.getFabricComponentName((String) this.mObjBuffer[i5])}));
                            i5 = i5 + 1 + 2;
                        } else {
                            if (i8 == 4) {
                                i3 = i4 + 1;
                                sb.append(String.format("DELETE [%d]\n", new Object[]{Integer.valueOf(this.mIntBuffer[i4])}));
                            } else if (i8 == 8) {
                                int i11 = i4 + 1;
                                int i12 = i11 + 1;
                                i2 = i12 + 1;
                                sb.append(String.format("INSERT [%d]->[%d] @%d\n", new Object[]{Integer.valueOf(this.mIntBuffer[i4]), Integer.valueOf(this.mIntBuffer[i11]), Integer.valueOf(this.mIntBuffer[i12])}));
                            } else if (i8 == 16) {
                                int i13 = i4 + 1;
                                int i14 = i13 + 1;
                                i2 = i14 + 1;
                                sb.append(String.format("REMOVE [%d]->[%d] @%d\n", new Object[]{Integer.valueOf(this.mIntBuffer[i4]), Integer.valueOf(this.mIntBuffer[i13]), Integer.valueOf(this.mIntBuffer[i14])}));
                            } else if (i8 == 32) {
                                castToProps(this.mObjBuffer[i5]);
                                i2 = i4 + 1;
                                sb.append(String.format("UPDATE PROPS [%d]: %s\n", new Object[]{Integer.valueOf(this.mIntBuffer[i4]), "<hidden>"}));
                                i5++;
                            } else if (i8 == 64) {
                                i5++;
                                i3 = i4 + 1;
                                ...
                                if (i8 == 128) {
                                    ...
                                    int i18 = i17 + 1;
                                    int i19 = i18 + 1;
                                    sb.append(String.format("UPDATE LAYOUT [%d]: x:%d y:%d w:%d h:%d layoutDirection:%d\n", new Object[]{Integer.valueOf(this.mIntBuffer[i4]), Integer.valueOf(this.mIntBuffer[i15]), Integer.valueOf(this.mIntBuffer[i16]), Integer.valueOf(this.mIntBuffer[i17]), Integer.valueOf(this.mIntBuffer[i18]), Integer.valueOf(this.mIntBuffer[i19])}));
                                    i4 = i19 + 1;
                                } else if (i8 == 512) {
                                    int i20 = i4 + 1;
                                    int i21 = i20 + 1;
                                    int i22 = i21 + 1;
                                    int i23 = i22 + 1;
                                    sb.append(String.format("UPDATE PADDING [%d]: top:%d right:%d bottom:%d left:%d\n", new Object[]{Integer.valueOf(this.mIntBuffer[i4]), Integer.valueOf(this.mIntBuffer[i20]), Integer.valueOf(this.mIntBuffer[i21]), Integer.valueOf(this.mIntBuffer[i22]), Integer.valueOf(this.mIntBuffer[i23])}));
                                    i4 = i23 + 1;
                                } else if (i8 == 256) {
                                    i5++;
                                    i3 = i4 + 1;
                                    ...
                                    String str = TAG;
                                    FLog.m48e(str, "String so far: " + sb.toString());
