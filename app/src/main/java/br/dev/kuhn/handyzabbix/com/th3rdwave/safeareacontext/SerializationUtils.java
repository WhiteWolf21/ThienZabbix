...
class SerializationUtils {
    ...
    static Map<String, Float> rectToJavaMap(Rect rect) {
        return MapBuilder.m126of("x", Float.valueOf(PixelUtil.toDIPFromPixel(rect.f281x)), "y", Float.valueOf(PixelUtil.toDIPFromPixel(rect.f282y)), "width", Float.valueOf(PixelUtil.toDIPFromPixel(rect.width)), "height", Float.valueOf(PixelUtil.toDIPFromPixel(rect.height)));
    }
}
