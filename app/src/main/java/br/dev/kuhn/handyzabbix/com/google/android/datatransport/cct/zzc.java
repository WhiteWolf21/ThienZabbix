...
import com.google.android.datatransport.cct.p006a.zzaa;
...
import com.google.android.datatransport.cct.p006a.zzv;
import com.google.android.datatransport.cct.p006a.zzx;
import com.google.android.datatransport.cct.p006a.zzy;
...
final class zzc implements TransportBackend {
    ...
    public EventInternal decorate(EventInternal eventInternal) {
        ...
        if (activeNetworkInfo == null) {
            i2 = zzy.zzb.UNKNOWN_MOBILE_SUBTYPE.zza();
        } else {
            i2 = activeNetworkInfo.getSubtype();
            if (i2 == -1) {
                i2 = zzy.zzb.COMBINED.zza();
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            ...
            Logging.m142e("CctTransportBackend", "Could not make request to the backend", e);
            return BackendResponse.transientError();
        }
    }
    ...
    public zzb zza(zza zza2) throws IOException {
        ...
        try {
            ...
            try {
                ...
                Logging.m143i("CctTransportBackend", sb.toString());
                StringBuilder sb2 = new StringBuilder();
                sb2.append("Content-Type: ");
                sb2.append(httpURLConnection.getHeaderField("Content-Type"));
                Logging.m143i("CctTransportBackend", sb2.toString());
                StringBuilder sb3 = new StringBuilder();
                sb3.append("Content-Encoding: ");
                sb3.append(httpURLConnection.getHeaderField("Content-Encoding"));
                Logging.m143i("CctTransportBackend", sb3.toString());
                if (!(responseCode == 302 || responseCode == 301)) {
                    if (responseCode != 307) {
                        if (responseCode != 200) {
                            zzb zzb2 = new zzb(responseCode, (URL) null, 0);
                            newChannel.close();
                            return zzb2;
                        }
                        ...
                        zzb zzb3 = new zzb(responseCode, (URL) null, zzx.zza(new InputStreamReader(inputStream)).zza());
                        inputStream.close();
                        newChannel.close();
                        return zzb3;
                    }
                }
                zzb zzb4 = new zzb(responseCode, new URL(httpURLConnection.getHeaderField("Location")), 0);
                newChannel.close();
                return zzb4;
            } catch (EncodingException | IOException e) {
                Logging.m142e("CctTransportBackend", "Couldn't encode request, returning with 400", e);
                zzb zzb5 = new zzb(StatFsHelper.DEFAULT_DISK_YELLOW_LEVEL_IN_MB, (URL) null, 0);
                gZIPOutputStream.close();
                newChannel.close();
                return zzb5;
            }
