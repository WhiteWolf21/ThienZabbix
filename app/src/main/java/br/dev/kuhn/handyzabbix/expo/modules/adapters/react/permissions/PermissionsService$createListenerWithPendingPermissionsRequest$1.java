...
@Metadata(mo24972bv = {1, 0, 3}, mo24973d1 = {"\u0000\"\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0011\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0015\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032,\u0010\u0004\u001a(\u0012\f\u0012\n \u0007*\u0004\u0018\u00010\u00060\u0006 \u0007*\u0014\u0012\u000e\b\u0001\u0012\n \u0007*\u0004\u0018\u00010\u00060\u0006\u0018\u00010\u00050\u00052\u000e\u0010\b\u001a\n \u0007*\u0004\u0018\u00010\t0\tH\n¢\u0006\u0004\b\n\u0010\u000b"}, mo24974d2 = {"<anonymous>", "", "requestCode", "", "receivePermissions", "", "", "kotlin.jvm.PlatformType", "grantResults", "", "onRequestPermissionsResult", "(I[Ljava/lang/String;[I)Z"}, mo24975k = 3, mo24976mv = {1, 4, 1})
...
final class PermissionsService$createListenerWithPendingPermissionsRequest$1 implements PermissionListener {
    ...
    public final boolean onRequestPermissionsResult(int r8, java.lang.String[] r9, int[] r10) {
        /*
            ...
            expo.modules.adapters.react.permissions.PermissionsService r8 = r7.this$0
            monitor-enter(r8)
            expo.modules.adapters.react.permissions.PermissionsService r2 = r7.this$0     // Catch:{ all -> 0x00ef }
            expo.modules.interfaces.permissions.PermissionsResponseListener r2 = r2.mCurrentPermissionListener     // Catch:{ all -> 0x00ef }
            if (r2 == 0) goto L_0x00e1
            expo.modules.adapters.react.permissions.PermissionsService r3 = r7.this$0     // Catch:{ all -> 0x00ef }
            ...
            expo.modules.adapters.react.permissions.PermissionsService r9 = r7.this$0     // Catch:{ all -> 0x00ef }
            r10 = 0
            r2 = r10
            expo.modules.interfaces.permissions.PermissionsResponseListener r2 = (expo.modules.interfaces.permissions.PermissionsResponseListener) r2     // Catch:{ all -> 0x00ef }
            ...
            expo.modules.adapters.react.permissions.PermissionsService r2 = r7.this$0     // Catch:{ all -> 0x00ef }
            expo.modules.core.interfaces.ActivityProvider r2 = r2.mActivityProvider     // Catch:{ all -> 0x00ef }
        ...
        L_0x004e:
            ...
            expo.modules.interfaces.permissions.PermissionsResponseListener r10 = (expo.modules.interfaces.permissions.PermissionsResponseListener) r10     // Catch:{ all -> 0x00ef }
            expo.modules.adapters.react.permissions.PermissionsService r0 = r7.this$0     // Catch:{ all -> 0x00ef }
        ...
        L_0x0085:
            ...
            expo.modules.interfaces.permissions.PermissionsResponseListener r0 = (expo.modules.interfaces.permissions.PermissionsResponseListener) r0     // Catch:{ all -> 0x00ef }
            expo.modules.adapters.react.permissions.PermissionsService r2 = r7.this$0     // Catch:{ all -> 0x00ef }
        ...
        L_0x00c2:
            ...
            expo.modules.interfaces.permissions.PermissionsResponseListener r3 = (expo.modules.interfaces.permissions.PermissionsResponseListener) r3     // Catch:{ all -> 0x00ef }
        ...
        L_0x00f2:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: expo.modules.adapters.react.permissions.PermissionsService$createListenerWithPendingPermissionsRequest$1.onRequestPermissionsResult(int, java.lang.String[], int[]):boolean");
    }
}
