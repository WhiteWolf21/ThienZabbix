...
public class ReactViewGroup extends ViewGroup implements ReactInterceptingViewGroup, ReactClippingViewGroup, ReactPointerEventsView, ReactHitSlopView, ReactZIndexedViewGroup {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        try {
            ...
            FLog.m49e(ReactConstants.TAG, "Exception thrown when executing ReactViewGroup.dispatchDraw method on ReactViewGroup[" + getId() + "]", e);
            int childCount2 = getChildCount();
            int i = 0;
            FLog.m50e(ReactConstants.TAG, "Initial Child Count: %d / final: %d", Integer.valueOf(childCount), Integer.valueOf(childCount2));
            FLog.m48e(ReactConstants.TAG, "Child List:");
            while (true) {
                int i2 = -1337;
                if (i >= childCount2) {
                    break;
                ...
                sb.append(" - ");
                if (childAt != null) {
                    str = childAt.toString();
                } else {
                    str = "<null>";
                }
                sb.append(str);
                FLog.m48e(ReactConstants.TAG, sb.toString());
                i++;
            }
            FLog.m48e(ReactConstants.TAG, "Ancestor List:");
            for (ViewParent parent = getParent(); parent != null; parent = parent.getParent()) {
                ViewGroup viewGroup = parent instanceof ViewGroup ? (ViewGroup) parent : null;
                int id = viewGroup != null ? viewGroup.getId() : -1337;
                FLog.m48e(ReactConstants.TAG, "Ancestor[" + id + "]: " + parent.toString());
            }
