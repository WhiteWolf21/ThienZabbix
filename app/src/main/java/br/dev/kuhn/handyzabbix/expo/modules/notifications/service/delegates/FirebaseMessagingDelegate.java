...
import br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.JSONNotificationContentBuilder;
import br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.RemoteMessageSerializer;
import br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.background.BackgroundRemoteNotificationTaskConsumer;
import br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.model.Notification;
import br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.model.NotificationContent;
import br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.model.NotificationRequest;
import br.dev.kuhn.handyzabbix.expo.modules.notifications.notifications.model.triggers.FirebaseNotificationTrigger;
...
@Metadata(mo24972bv = {1, 0, 3}, mo24973d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0005\b\u0016\u0018\u0000 \u001c2\u00020\u0001:\u0001\u001cB\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0010\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0004J \u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0012H\u0014J\f\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00150\u0014J\u0010\u0010\u0016\u001a\u00020\u000e2\u0006\u0010\t\u001a\u00020\nH\u0004J\b\u0010\u0017\u001a\u00020\u0018H\u0016J\u0010\u0010\u0019\u001a\u00020\u00182\u0006\u0010\t\u001a\u00020\nH\u0016J\u0010\u0010\u001a\u001a\u00020\u00182\u0006\u0010\u001b\u001a\u00020\u000eH\u0016R\u0014\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u001d"}, mo24974d2 = {"Lexpo/modules/notifications/service/delegates/FirebaseMessagingDelegate;", "Lexpo/modules/notifications/service/interfaces/FirebaseMessagingDelegate;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "getContext", "()Landroid/content/Context;", "createNotification", "Lexpo/modules/notifications/notifications/model/Notification;", "remoteMessage", "Lcom/google/firebase/messaging/RemoteMessage;", "createNotificationRequest", "Lexpo/modules/notifications/notifications/model/NotificationRequest;", "identifier", "", "content", "Lexpo/modules/notifications/notifications/model/NotificationContent;", "notificationTrigger", "Lexpo/modules/notifications/notifications/model/triggers/FirebaseNotificationTrigger;", "getBackgroundTasks", "", "Lexpo/modules/notifications/notifications/background/BackgroundRemoteNotificationTaskConsumer;", "getNotificationIdentifier", "onDeletedMessages", "", "onMessageReceived", "onNewToken", "token", "Companion", "expo-notifications_release"}, mo24975k = 1, mo24976mv = {1, 4, 1})
/* compiled from: FirebaseMessagingDelegate.kt */
public class FirebaseMessagingDelegate implements br.dev.kuhn.handyzabbix.expo.modules.notifications.service.interfaces.FirebaseMessagingDelegate {
    ...
    public static final class Companion {
        ...
        public final void addTokenListener(FirebaseTokenListener firebaseTokenListener) {
            ...
            if (!companion.getSTokenListenersReferences().containsKey(firebaseTokenListener)) {
                companion.getSTokenListenersReferences().put(firebaseTokenListener, new WeakReference(firebaseTokenListener));
                if (companion.getSLastToken() != null) {
                    firebaseTokenListener.onNewToken(companion.getSLastToken());
                }
            }
        }
        ...
        public final void addBackgroundTaskConsumer(BackgroundRemoteNotificationTaskConsumer backgroundRemoteNotificationTaskConsumer) {
            ...
            Companion companion = this;
            if (!companion.getSBackgroundTaskConsumerReferences().containsKey(backgroundRemoteNotificationTaskConsumer)) {
                companion.getSBackgroundTaskConsumerReferences().put(backgroundRemoteNotificationTaskConsumer, new WeakReference(backgroundRemoteNotificationTaskConsumer));
            }
        }
    }
    ...
    public final Notification createNotification(RemoteMessage remoteMessage) {
        ...
        Intrinsics.checkNotNullExpressionValue(build, UriUtil.LOCAL_CONTENT_SCHEME);
    ...
    public NotificationRequest createNotificationRequest(String str, NotificationContent notificationContent, FirebaseNotificationTrigger firebaseNotificationTrigger) {
        ...
        Intrinsics.checkNotNullParameter(notificationContent, UriUtil.LOCAL_CONTENT_SCHEME);
