...
public class SQLiteEventStore implements EventStore, SynchronizationGuard {
    ...
    public PersistedEvent persist(TransportContext transportContext, EventInternal eventInternal) {
        Logging.m141d(LOG_TAG, "Storing event with priority=%s, name=%s for destination %s", transportContext.getPriority(), eventInternal.getTransportName(), transportContext.getBackendName());
    ...
    static /* synthetic */ Long lambda$persist$1(SQLiteEventStore sQLiteEventStore, TransportContext transportContext, EventInternal eventInternal, SQLiteDatabase sQLiteDatabase) {
        ...
        for (Map.Entry next : eventInternal.getMetadata().entrySet()) {
            ...
            contentValues2.put(RNConstants.ARG_VALUE, (String) next.getValue());
    ...
    public List<PersistedEvent> loadEvents(SQLiteDatabase sQLiteDatabase, TransportContext transportContext) {
        ...
        tryWithCursor(sQLiteDatabase2.query("events", new String[]{"_id", "transport_name", "timestamp_ms", "uptime_ms", "payload_encoding", "payload", "code"}, "context_id = ?", new String[]{transportContextId.toString()}, (String) null, (String) null, (String) null, String.valueOf(this.config.getLoadBatchSize())), SQLiteEventStore$$Lambda$15.lambdaFactory$(arrayList, transportContext));
        return arrayList;
    }
    ...
    private Map<Long, Set<Metadata>> loadMetadata(SQLiteDatabase sQLiteDatabase, List<PersistedEvent> list) {
        ...
        sb.append(')');
        tryWithCursor(sQLiteDatabase.query("event_metadata", new String[]{"event_id", "name", RNConstants.ARG_VALUE}, sb.toString(), (String[]) null, (String) null, (String) null, (String) null), SQLiteEventStore$$Lambda$16.lambdaFactory$(hashMap));
        return hashMap;
    }
