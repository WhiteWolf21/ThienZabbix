...
public class JavaOnlyArray implements ReadableArray, WritableArray {
    ...
    /* renamed from: of */
    public static JavaOnlyArray m120of(Object... objArr) {
    ...
    public static JavaOnlyArray deepClone(ReadableArray readableArray) {
        ...
        for (int i = 0; i < size; i++) {
            switch (C09471.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C09471 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.bridge.JavaOnlyArray.C09471.<clinit>():void");
        }
    }
