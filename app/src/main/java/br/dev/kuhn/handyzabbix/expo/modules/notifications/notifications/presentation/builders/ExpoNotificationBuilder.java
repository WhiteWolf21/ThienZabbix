...
public class ExpoNotificationBuilder extends ChannelAwareNotificationBuilder {
    ...
    public byte[] marshallNotificationRequest(NotificationRequest notificationRequest) {
        try {
            ...
            Log.e("expo-notifications", String.format("Could not marshalled notification request: %s.", new Object[]{notificationRequest.getIdentifier()}));
            e.printStackTrace();
            return null;
        }
    }
    ...
    public Number getColor() {
        ...
        try {
            ...
            if (applicationInfo.metaData.containsKey(META_DATA_DEFAULT_COLOR_KEY)) {
                ...
                return Integer.valueOf(getContext().getResources().getColor(applicationInfo.metaData.getInt(META_DATA_DEFAULT_COLOR_KEY)));
            }
