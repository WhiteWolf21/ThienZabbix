        ...
        for (Map.Entry next : this.mMapping.entrySet()) {
            ...
            if (findNodeById instanceof StyleNode) {
                ...
                while (keySetIterator.hasNextKey()) {
                    ...
                    int i = C16551.$SwitchMap$com$facebook$react$bridge$ReadableType[type.ordinal()];
                    if (i == 1) {
    ...
    static /* synthetic */ class C16551 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.swmansion.reanimated.nodes.PropsNode.C16551.<clinit>():void");
        }
    }
