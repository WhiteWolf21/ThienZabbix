...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C1242R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C1242R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C1242R.attr.colorSurface, 0);
