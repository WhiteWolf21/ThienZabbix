...
public class SplashScreenViewController {
    ...
    /* access modifiers changed from: private */
    public final View splashScreenView;
    ...
    public void showSplashScreen(Function0<Unit> function0) {
        ...
        if (activity != null) {
            activity.runOnUiThread(new SplashScreenViewController$showSplashScreen$2(this, function0));
        }
    }
    ...
    public void hideSplashScreen(Function1<? super Boolean, Unit> function1, Function1<? super String, Unit> function12) {
        ...
        if (activity == null || activity.isFinishing() || activity.isDestroyed()) {
            ...
            activity.runOnUiThread(new SplashScreenViewController$hideSplashScreen$3(this, function1));
        }
    }
    ...
    public final void searchForRootView() {
        if (this.rootView == null) {
            ...
            if (findRootView != null) {
                ...
                this.handler.postDelayed(new SplashScreenViewController$searchForRootView$2(this), 20);
            }
        }
    }
