...
final class ReactNativeHostWrapper$getJSBundleFile$1 extends Lambda implements Function1<ReactNativeHostHandler, String> {
    final /* synthetic */ ReactNativeHostWrapper this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ReactNativeHostWrapper$getJSBundleFile$1(ReactNativeHostWrapper reactNativeHostWrapper) {
        super(1);
