...
public class ReadableNativeMap extends NativeMap implements ReadableMap {
    ...
    public HashMap<String, Object> toHashMap() {
        ...
        for (String next : hashMap.keySet()) {
            switch (C09541.$SwitchMap$com$facebook$react$bridge$ReadableType[getType(next).ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
    ...
    static /* synthetic */ class C09541 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.bridge.ReadableNativeMap.C09541.<clinit>():void");
        }
    }
