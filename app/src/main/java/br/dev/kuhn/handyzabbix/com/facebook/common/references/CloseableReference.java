...
public final class CloseableReference<T> implements Cloneable, Closeable {
    ...
    private static final LeakHandler DEFAULT_LEAK_HANDLER = new LeakHandler() {
        ...
        public void reportLeak(SharedReference<Object> sharedReference, @Nullable Throwable th) {
            FLog.m86w((Class<?>) CloseableReference.TAG, "Finalized without closing: %x %x (type = %s)", Integer.valueOf(System.identityHashCode(this)), Integer.valueOf(System.identityHashCode(sharedReference)), sharedReference.get().getClass().getName());
        }
    };
    ...
    /* renamed from: of */
    public static <T extends Closeable> CloseableReference<T> m112of(T t) {
        return m114of(t, DEFAULT_CLOSEABLE_RELEASER);
    }

    /* renamed from: of */
    public static <T extends Closeable> CloseableReference<T> m113of(T t, LeakHandler leakHandler) {
        Throwable th = null;
        if (t == null) {
            return null;
        }
    ...
    /* renamed from: of */
    public static <T> CloseableReference<T> m114of(T t, ResourceReleaser<T> resourceReleaser) {
        return m115of(t, resourceReleaser, DEFAULT_LEAK_HANDLER);
    }

    /* renamed from: of */
    public static <T> CloseableReference<T> m115of(T t, ResourceReleaser<T> resourceReleaser, LeakHandler leakHandler) {
        Throwable th = null;
        if (t == null) {
            return null;
        }
