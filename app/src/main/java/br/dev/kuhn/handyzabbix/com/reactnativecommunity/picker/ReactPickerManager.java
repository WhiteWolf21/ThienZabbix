...
public abstract class ReactPickerManager extends BaseViewManager<ReactPicker, ReactPickerShadowNode> {
    ...
    public Map<String, Object> getExportedCustomBubblingEventTypeConstants() {
        return MapBuilder.builder().put("topSelect", MapBuilder.m123of("phasedRegistrationNames", MapBuilder.m124of("bubbled", "onSelect", "captured", "onSelectCapture"))).put(PickerFocusEvent.EVENT_NAME, MapBuilder.m123of("phasedRegistrationNames", MapBuilder.m124of("bubbled", "onFocus", "captured", "onFocusCapture"))).put(PickerBlurEvent.EVENT_NAME, MapBuilder.m123of("phasedRegistrationNames", MapBuilder.m124of("bubbled", "onBlur", "captured", "onBlurCapture"))).build();
    }

    @Nullable
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m124of("focus", 1, "blur", 2);
    }
    ...
    private static class ReactPickerAdapter extends BaseAdapter {
        ...
        private View getView(int i, View view, ViewGroup viewGroup, boolean z) {
            ...
            if (view == null) {
                if (z) {
                    i2 = C1588R.layout.simple_spinner_dropdown_item;
                } else {
                    i2 = C1588R.layout.simple_spinner_item;
                }
