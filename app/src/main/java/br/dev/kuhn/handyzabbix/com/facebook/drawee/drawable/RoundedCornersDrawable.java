...
public class RoundedCornersDrawable extends ForwardingDrawable implements Rounded {
    ...
    static /* synthetic */ class C07581 {
        ...
        static final /* synthetic */ int[] f151xda0cffae;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f151xda0cffae     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.drawee.drawable.RoundedCornersDrawable.C07581.<clinit>():void");
        }
    }

    public void draw(Canvas canvas) {
        this.mBounds.set(getBounds());
        int i = C07581.f151xda0cffae[this.mType.ordinal()];
        if (i == 1) {
